...
yara_export_exception_list_filepath = 'datasrc/yara-export-discarded.txt' #contain a list of name of yara rule (one per line) to exclude from the yara export function
